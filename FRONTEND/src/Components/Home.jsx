...
// import { FaLinkedin, FaDownload, FaGithub, FaExternalLinkAlt, FaCode, FaStar, FaBriefcase, FaCalendarAlt, FaBuilding } from "react-icons/fa";
// import {
//   FaHtml5,
//   FaCss3Alt,
//   FaJsSquare,
...
//       }
//     };
//   }, [isDarkTheme, isMobile, particleCount, handleResize, handleAboutResize, handleProjectsResize, handleSkillsResize, handleExperienceResize, handleMouseMove, handleMouseOut]);
...
//           .sr-skill-card, .sr-skills-card, .sr-experience-card {
//             font-size: 0.75rem;
...
//           .sr-fade, .sr-left, .sr-right, .sr-about-heading, .sr-about-text, .sr-about-image, .sr-button, .sr-skill-card, .sr-skills-heading, .sr-skills-card, .sr-experience-heading, .sr-experience-card, .sr-experience-timeline {
//             opacity: 1 !important;
...
//         .sr-button:focus-visible, .sr-experience-card:focus-visible {
//           outline: 2px solid #fb7185;
//           outline-offset: 2px;
//         }
        
//         /* Smooth transitions for all interactive elements */
//         .sr-skill-card, .sr-button, .sr-skills-card, .sr-experience-card {
